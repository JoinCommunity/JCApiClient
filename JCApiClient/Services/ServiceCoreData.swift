...
public class ServiceCoreData {
    ...
    static var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "JoinCommunity", managedObjectModel: ServiceCoreData.managedObjectModel)
    ...
    public class func saveContext () {
        let context = ServiceCoreData.viewContext
